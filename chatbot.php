      ...
      <div class="ourwork">
          <div class="container">
             <div class="row">
                <div class="col-md-12">
                   <div class="titlepage">
                      <h2>ChatBot por Arnold Guerrero</h2>
                   </div>
                   <p>Un chatbot es un sistema de apoyo para su atención al cliente. Con inteligencia artificial y procesamiento del lenguaje natural, su chatbot puede simular una conversación con un usuario a través de aplicaciones de mensajería, sitios web, aplicaciones móviles y más, y ofrecerle información precisa y relevante.</p>
                </div>
             </div>
             <div class="row">
             <div class="col-md-12">
                   <div class="our_box">
                      <figure><img src="images/chatbot.jpg" alt="#"/></figure>
                   </div>
                </div>
             </div>
          </div>
