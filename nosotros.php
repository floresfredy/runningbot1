            ...
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="titlepage">
                     ...
                     <span></span>
                     <p>Es un proyecto que aprovecha la inteligencia artificial usando diferentes servicios que ofrece la nube de IBMCloud, la cual ayuda a la Universidad de San Martin de Porres Facultad de Ingeniería y Arquitectura.</p>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="about_img">
         ...
         <div class="container">
            <div class="row d_flex">
               ...
               <div class="titlepage">
                     <h2>Misión</h2>
                     <span></span>
                     <p>Inspirar y ayudar a los estudiantes universitarios a que realicen actividades físicas, mediante solvataciones de dudas y consejos de mejora.</p>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="titlepage">
                     <h2>Visión</h2>
                     <span></span>
                     <p>Ser la mejor plataforma de consulta de actividad física y registro en Perú mediante sensores.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row d_flex">
               <div class="col-md-8">
                  <div class="titlepage">
                     <h2>Propuesta</h2>
                     <span></span>
                     <p>Facilitar diferentes dudas que tengan los estudiantes universitarios de la univerdad USMP.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="about_img">
                     <figure><img src="images/caracteristicas.jpg" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
