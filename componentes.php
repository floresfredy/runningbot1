      ...
      <div class="ourwork">
          <div class="container">
             ...
             <div class="row">
                <div class="col-md-6">
                   <div class="jonu">
                      <a href="iot.php"><figure><img src="images/iot.jpg" alt="#"/></figure>
                      <strong>IOT</strong></a>
                   </div>
                </div>
                <div class="col-md-6">
                  <div class="jonu">
                      <a href="realidad.php"><figure><img src="images/realidad.jpg" alt="#"/></figure>
                      <strong>Realidad Virtual</strong></a>
                   </div>
                </div>
                
                <div class="col-md-6">
                  <div class="jonu">
                      <a href="chatbot.php"><figure><img src="images/chatbot.png" alt="#"/></figure>
                      <strong>ChatBot</strong></a>
                   </div>
                </div>
                <div class="col-md-6">
                  <div class="jonu">
                      <a href="facial.php"><figure><img src="images/facial.jpg" alt="#"/></figure>
                      <strong>Reconocimiento Facial</strong></a>
                   </div>
                </div>
             </div>
          </div>
