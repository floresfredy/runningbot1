      ...
      <div class="ourwork">
          <div class="container">
             <div class="row">
                <div class="col-md-12">
                   <div class="titlepage">
                      <h2>Internet de las cosas por Giancarlo Ayala</h2>
                   </div>
                   <p>IBM Watson IoT Platform es un servicio completamente gestionado, multi-tenant y alojado en cloud. El Servicio de Cloud también permite realizar analíticas en los datos de los dispositivos conectados.</p>
                </div>
             </div>
             <div class="row">
                <div class="col-md-12">
